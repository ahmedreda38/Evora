  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-br from-secondary/10 via-primary/5 to-surface rounded-[100%] blur-3xl opacity-60 mix-blend-multiply transform rotate-12 scale-150"></div>
      </div>
      ...
      >
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <Link to="/login" className="font-medium text-accent hover:text-[#d68566] transition-colors">
              Sign in
            </Link>
          </p>
        </div>
